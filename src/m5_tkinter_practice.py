...
def main():
    ...
    third_button = ttk.Button(frame1, text='Print first string N times')
    third_button['command'] = lambda: third_button_task(my_entry_box, second_box)
    third_button.grid()
    ####################################################################
    # HINT:
    ...
    # ------------------------------------------------------------------
    smart_button = ttk.Button(frame1, text='Click for a smart comment')
    smart_button.grid()

    smart_button['command'] = lambda: print('Time does not permit')
...
def third_button_task(in_string, n_times):
    input_string = in_string.get()
    num = n_times.get()

    print(input_string * int(num))
# ----------------------------------------------------------------------
